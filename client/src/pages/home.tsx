          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl lg:text-6xl font-bold font-playfair mb-6">
                Welcome back, <span className="text-gradient">{user?.firstName || 'Founder'}</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Your journey continues. Connect, share, and grow with the Let's Go community.
              </p>
              ...
              {needsProfile && (
                <Card className="max-w-2xl mx-auto mb-8 border-accent-blue border-2">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-300 mb-4">Tell the community about yourself and what you're building.</p>
                    <Button 
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <Card className="bg-dark-gray border-gray-600">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gradient">{posts?.length || 0}</div>
